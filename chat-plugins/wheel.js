		...
		spin: function (target, room, user) {
			...
			setTimeout( function() {
				...
				if (!wheelResult) {
					...
					return user.sendTo(room, generateDisplay(room, true, false, '<div style="background: rgba(255, 68, 89, 0.6); border: 1px solid #FF0000; border-radius: 5px; padding: 5px;"><b><font style="color: #FF0000; font-family: Calibri; font-size: 11pt;">' + 

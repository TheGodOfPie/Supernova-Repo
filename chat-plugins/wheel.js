		...
		spin: function (target, room, user) {
			...
			setTimeout( function() {
				...
				if (!wheelResult) {
					...
					return user.sendTo(room, generateDisplay(room, true, false, '<div style="background: rgba(255, 119, 137, 0.8); border: 1px solid #FF0000; border-radius: 5px; padding: 5px;"><b><font style="color: #C60000; font-family: Verdana; font-size: 10pt;">' + 

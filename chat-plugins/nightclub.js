        ...
        nightclub: {
                enable: function (target, room, user) {
                        ...
                        if (!room.chatRoomData) {
                                return this.sendReply("Nightclub can't be enable in this room.");
                        }
                        if (room.chatRoomData.hasNightclub) return this.errorReply('This room already has a nightclub.');
                        room.hasNightclub = true;
                        this.addModCommand("" + user.name + " added nightclub to this room.");
                        room.chatRoomData.hasNightclub = true;
                        Rooms.global.writeChatRoomData();
                },
                disable: function (target, room, user) {
                        if (!room.chatRoomData.hasNightclub) return this.errorReply('This room does not have a nightclub.');
                        delete room.hasNightclub;
                        this.addModCommand("" + user.name + " removed nightclub from this room.");
                        delete room.chatRoomData.hasNightclub;
                        Rooms.global.writeChatRoomData();
                },
                ...
                on: function (target, room, user) {
                        ...
                        if (!room.chatRoomData.hasNightclub) return this.sendReply("Only rooms with Nightclub can start the party!");
